...
function get_teachers() {
    ...
    const teacher_arr = [
        ...
        ['英丽萍 ', 'Ying LiPing', 'yingliping_2.jpg', '教师', '毕业于山东师范学院，现研修新加坡教育管理研究生课程，具备扎实的教育理论基础与国际化教育视野。拥有多年中国公立学校语文教学经验，长期从事语文课堂教学与学生管理工作，熟悉课程设计、教学实施及教育评价。注重学生综合素养培养，善于结合现代教育理念提升课堂教学效果，具有良好的沟通协调能力与教育实践能力。'],
