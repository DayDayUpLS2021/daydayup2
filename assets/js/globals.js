...
function get_teachers() {
    ...
    const teacher_arr = [
        ...
        ['王晓松', 'Wang XiaoSong', 'wangxiaosong2.jpg', '实体课总负责人', '2003年毕业于西北工业大学工商管理专业，学士学位.曾先后在中国政府及私立学校任教。期间获得中国教师资格证书.普通话一级乙等.2012年至今担任樱花国际日语大连.青岛深圳等校区校长职务，负责校区的整体运营管理工作。拥有较强的组织和沟通能力，敢于面对挑战。'],
        ['郑源元', 'Zheng YuanYuan', 'zhengyuanyuan2.jpg', '实体课中学部负责人', '2020毕业于新加坡SMU，拥有管理硕士学位。是一位经验丰富的华语老师，在华语教学领域有丰富经验，深受学生和家长的喜爱与尊重。郑老师擅长针对不同年龄段和语言水平的学生制定个性化的学习计划，帮助他们在听、说、读、写各方面取得全面进步。他的教学方法灵活多样，既注重传统的语法和词汇教学，也善于利用现代科技和多媒体资源，使课堂生动有趣。郑老师注重培养学生的语言兴趣和自信心，常常通过有趣的故事和游戏来激发他们的学习热情。他还特别重视与学生的互动和沟通，善于发现每个学生的优势和潜力，并给予及时的鼓励和指导。他的教学理念是“因材施教，寓教于乐”，致力于为每一个学生提供最优质的华语学习体验。'],
        ...
        ['郑建一', 'Zheng JianYi', 'zhengjianyi2.jpg', '实体课小学部负责人', '2010毕业于中国大连外国语大学，文学学士学位。他热爱教育事业，熟悉国内外中小学生生活及学生特点，在教学的过程中不断学习和研究良好的教学方法，为人专业严谨、幽默负责、亲和力强，善于根据学生特点，及时调整教学策略，因材施教，制定个性化教学方案，用有效的方法解决语文问题。他认为正视孩子的问题，理解孩子的需要，肯定孩子的进步，欣赏孩子的优点。'],
        ...
        ['冷静', 'Len Jing', 'teacher.jpg', '教师', ''],
        ['卓睿庆', 'Zhuo RuiQing', 'zhuoruiqing2.jpg', '教师', ''],
        ['冯婌清', 'Adeline Pang SooCheng', 'fengshuqing2.jpg', '教师', ''],
        ['李凌飞', 'Li LingFei', 'lilingfei2.jpg', '教师', ''],
        ['曲世军', 'Qu ShiJun', 'qushijun2.jpg', '教师', ''],
