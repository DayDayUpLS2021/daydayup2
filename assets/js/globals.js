...
function get_teachers() {
    ...
    const teacher_arr = [
        ...
        ['郑源元', 'Zheng YuanYuan', 'zhengyuanyuan_2.jpg', '创始人', '2020毕业于新加坡SMU，拥有管理硕士学位。是一位经验丰富的华语老师，在华语教学领域有丰富经验，深受学生和家长的喜爱与尊重。郑老师擅长针对不同年龄段和语言水平的学生制定个性化的学习计划，帮助他们在听、说、读、写各方面取得全面进步。他的教学方法灵活多样，既注重传统的语法和词汇教学，也善于利用现代科技和多媒体资源，使课堂生动有趣。郑老师注重培养学生的语言兴趣和自信心，常常通过有趣的故事和游戏来激发他们的学习热情。他还特别重视与学生的互动和沟通，善于发现每个学生的优势和潜力，并给予及时的鼓励和指导。他的教学理念是“因材施教，寓教于乐”，致力于为每一个学生提供最优质的华语学习体验。'],

        ['郑娟', 'Zheng Juan', 'zhengjuan_2.jpg', '校长', '就读于上海华东师范大学教育管理专业，研究生。89年毕业后，曾先后在中国和新加坡两地的政府及私立学校一线任教35年。期间获得中国高级教师证书，辽宁省一等优质课教师，大连市骨干教师。<br/>坚持：教育必须以学生为中心，没有教不会的学生。'],

        ['王爽', 'Wang Shuang', 'wangshuang_2.jpg', '副校长', '1992年毕业于辽宁师范大学教育管理专业，从事小学教育工作20多年，期间获得中国颁发的高级教师资格证，还获得“大连市优秀教育工作者”称号。多年的教育教学经验，使她深刻地认识到，“家庭教育”是教育的关键，于是她开始关注家庭教育，并通过学习，获得了国家人力资源和社会保障部颁发的“家庭教育师”资格证书，并希望能帮到更多的家庭，更多的孩子！'],       
        
        ['王晓松', 'Wang XiaoSong', 'wangxiaosong_2.jpg', '副校长', '毕业于西北工业大学工商管理专业，学士学位.曾先后在中国政府及私立学校任教。期间获得中国教师资格证书.普通话一级乙等.曾担任樱花国际日语大连.青岛深圳等校区校长职务，负责校区的整体运营管理工作。拥有较强的组织和沟通能力，敢于面对挑战。'],
        ...
        ['郭辉', 'Guo Hui', 'guohui_2.jpg', '网课中学部负责人', '毕业于沈阳师范大学，持CTCSOL国际中文教师资格证，普通话一级乙等，英语六级。任职于大连新闻传媒集团，具有良好的语言学知识及语音校准能力。专注新加坡O-Level华文备考教学，教学核心：识字基础夯实与阅读理解专项能力提升，可有效实现针对性提分。'],

        ['英丽萍 ', 'Ying LiPing', 'yingliping_2.jpg', '实体课中学部负责人', '毕业于山东师范学院，现研修新加坡教育管理研究生课程，具备扎实的教育理论基础与国际化教育视野。拥有多年中国公立学校语文教学经验，长期从事语文课堂教学与学生管理工作，熟悉课程设计、教学实施及教育评价。注重学生综合素养培养，善于结合现代教育理念提升课堂教学效果，具有良好的沟通协调能力与教育实践能力。'],

        ['陈宏民', 'Chen HongMin', 'chenhongmin_2.jpg', '网课小学部负责人', '1990年毕业于大连大学机械工程学院机械设计与制造专业，具有本科学历工学学士学位。自1990年大学毕业以来，从事中等职业教育教学一线工作15年，从事教育教学管理工作20年，期间获得中华人民共和国国家教育委员会颁发的中等职业学校教师资格证书和高级讲师职称。30多年来致力于教育教学工作，满腔热忱，相信学校教育能够改变学生的一生。'],

        ['陈晶珏', 'Chen JingJue', 'chenjingjue_2.jpg', '武吉知马分校负责人', '1994年毕业与南京理工大学机械工程专业，2000年来新加坡，2005学习完成ACCA课程。陈晶珏老师，性格开朗，有耐心，喜欢和孩子打交道，热爱教师工作。爱好广泛，擅长教具制作工作。'],

        ['蔡紫萱 ', 'Cai ZiXuan', 'caizixuan_2.jpg', '金文泰分校负责人', '拥有幼教经验，年轻有干劲儿，善于用真诚与热情与孩子拉近距离。注重营造尊重、鼓励与陪伴并存的课堂氛围。相信爱与耐心是教育最好的起点，也始终把“真诚、细致、责任心”作为一名老师应有的基本素养。'],

        ['陈姝遐 ', 'Chen ShuXia', 'chenshuxia_2.jpg', '教师', '毕业于澳洲联邦大学商业管理学士学位，考获马来西亚SPM和UEC中文双A佳绩。从事教培行业超过16年，相信知识能够改变命运，教育不仅仅在于成绩单的分数，更重要的是孩子能够被培养成一个思想独立、有良好品德、对社会有所贡献的人才。'],

        ['尹晓红', 'Yin XiaoHong', 'yinxiaohong2_2.jpg', '教师', '1998年毕业于西安工程大学，纺织品加工与贸易专业 ，全日制大学本科学历。于新闻媒体单位从事十多年文字工作及8年人力资源管理工作。教学理念：秉持以“学生为中心”的教学理念，深知因材施教的重要性，根据学生的特点和需求制定个性化教学计划。'],

        ['何济生', 'He JiSheng', 'hejisheng_2.jpg', '教师', '何老师，新加坡公民，毕业于新加坡国立大学（NUS），拥有语言学博士及硕士学位。精通中英文，具备丰富的语言教学知识与经验。持有新加坡国立教育学院（NIE）教育学研究生文凭，并接受过专业的中学华文教师培训。拥有16年新加坡教育部（MOE）学校教学经验，专业任教中学华文。具有丰富的学生备考与提分经验，尤其擅长帮助学生提升小学离校考试（PSLE）及O水准（O-Level）华文成绩。'],

        ['李琦（琦琦老师）', 'Li Qi', 'liqi_2.jpg', '教师', '2003年毕业于大连轻工业学院（现大连工业大学），从事教培行业十年，爱心丰盈，耐心充沛，善于沟通，教学风格多面有趣，深受孩子和家长认可。'],

        ['郑晓雯', 'Zheng XiaoWen', 'zhengxiaowen_2.jpg', '教师', '2013年毕业于中国大连交通大学工业设计专业，文学学士学位。中国书法等级认定中级，硬笔书法作品曾入选辽宁省硬笔书法家作品集，从事教培工作3年，用爱与耐心陪伴孩子们成长！'],
        
        //李凌飞=李师谊
        ['李凌飞', 'Li LingFei', 'lilingfei_2.jpg', '教师', '拥有三十余年媒体从业经历，为中国最早一批普通话一级甲等获得者。她曾于2006年参与美国密苏里新闻学院高级研修营并顺利结业，从业期间荣获东北三省好新闻奖五次，辽宁省好新闻奖二十余次。作为一名媒体从业者，她致力于教育战线，拥有丰富的写作教育经验，为青少年和成年人开展专业写作课程百余次。从事汉语言教学后，她深入研究国际学生学习汉语的规律，从学生的角度出发，深入浅出，激发学生的学习兴趣。她关爱孩子，充满活力，深受孩子们的喜爱。'],

        ['崔鑫', 'Cui Xin', 'cuixin_2.jpg', '教师', '1984年出生的崔鑫老师，2007年毕业于大连民族大学。同年在格林小学任教三年级数学老师一年，工作认真负责，班级数学成绩优秀。2008年至2010年在大连盖伦英语学校教英语课程，深受学生和家长的喜爱。2013年至2024年在大连程伟造价咨询有限公司，担任土建造价员，在职期间工作踏实肯干，深受领导信任。性格随和开朗，具有良好的协调沟通能力和团队合作精神。'],

        ['刘柏花', 'Liu BaiHua', 'liubaihua_2.jpg', '教师', '毕业于内蒙古大学汉语言文学系，曾在央企从事新闻及办公室调研工作30余年。拥有扎实的专业知识与认知能力。情绪稳定，乐观坚韧，耐心包容且富有亲和力。'],
        
        ['黄绍杰', 'Huang ShaoJie', 'huangshaojie_2.jpg', '教师(实习生)', '毕业于华侨中学与华初。（等待当兵中）在求学过程中，积极参与学生会活动，并获得了许多宝贵的经验。愿意与大家分享经历，也愿意分享学习中文的乐趣。认为学习中文不只是为了应付考试，更重要的是了解中华文化。'],

        ['温凯杰', 'Wen KaiJie', 'wenkaijie_2.jpg', '教师(实习生)', '毕业于南华中学，小学起修读高级华文，中文成绩一向优秀。曾任课程辅助活动领袖，具责任感与领导力，教学耐心细致，注重理解与基础，助学生稳步进步。'],

        ['温凯畯', 'Wen KaiJun', 'wenkaijun_2.jpg', '教师(实习生)', '毕业于南华小学及华侨中学，华文及高级华文成绩优异。修读华文语文特选课程（华文文学）并获奖学金，曾在《联合早报》发表题为《青年对华文重视不足》的文章，亦曾参与义工补习，致力启发学生语文能力与兴趣。'],

        //['张丽春', 'Zhang LiChun', 'zhanglichun_2.jpg', '教师', '本人毕业于中国辽宁大学汉语言文学，89年毕业后，一直从事一线教育教学工作。期间获得中国高级教师资格证书，辽宁省一等优秀论文，多次被评为大连市优秀班主任，瓦房店市优秀班主任，瓦房店市骨干教师，大连市优秀辅导员等荣誉称号。<br/>教学理念：一切为了学生，为了学生的一切！'],
        ...
        ['曲家乾', 'Qu JiaQian', 'qujiaqian_2.jpg', '顾问', '中国硬笔书法家协会楷书教育专业委员会主任委员，辽宁省书法家协会会员。其硬笔书法作品曾入选全国硬笔书法展，书法作品曾获全国教师书法展金奖。作品被中国民族画院、钓鱼台宾馆收藏。'],

        ['曲世君', 'Qu ShiJun', 'qushijun_2.jpg', '教师', '1983年毕业于大连大学中文系（前大连师专）先后担任中学，中专语文老师。后考入国家公务员。'],

        ['郑建一', 'Zheng JianYi', 'zhengjianyi_2.jpg', '教材编写负责人', '2010毕业于中国大连外国语大学，文学学士学位。他热爱教育事业，熟悉国内外中小学生生活及学生特点，在教学的过程中不断学习和研究良好的教学方法，为人专业严谨、幽默负责、亲和力强，善于根据学生特点，及时调整教学策略，因材施教，制定个性化教学方案，用有效的方法解决语文问题。他认为正视孩子的问题，理解孩子的需要，肯定孩子的进步，欣赏孩子的优点。'],
        
        ['阮建军', 'Ruan JianJun', 'ruanjianjun_2.jpg', '技术顾问', '目前就读于新加坡国立大学（National University of Singapore, NUS），主修软件编程（Software Computing）。于2018年毕业于新加坡理工学院（Singapore Polytechnic）。曾经在Zetta Solution担任软件编程师（Software Developer），主要负责开发和维护软件应用程序，与团队合作进行软件设计和实现，解决软件问题并提供技术支持，并编写和维护技术文档。']        
