...
function get_teachers() {
    ...
    const teacher_arr = [
        ...
        ['郑源元', 'Zheng YuanYuan', 'zhengyuanyuan2.jpg', '校长', '2020毕业于新加坡SMU，拥有管理硕士学位。是一位经验丰富的华语老师，在华语教学领域有丰富经验，深受学生和家长的喜爱与尊重。郑老师擅长针对不同年龄段和语言水平的学生制定个性化的学习计划，帮助他们在听、说、读、写各方面取得全面进步。他的教学方法灵活多样，既注重传统的语法和词汇教学，也善于利用现代科技和多媒体资源，使课堂生动有趣。郑老师注重培养学生的语言兴趣和自信心，常常通过有趣的故事和游戏来激发他们的学习热情。他还特别重视与学生的互动和沟通，善于发现每个学生的优势和潜力，并给予及时的鼓励和指导。他的教学理念是“因材施教，寓教于乐”，致力于为每一个学生提供最优质的华语学习体验。'],

        ['王晓松', 'Wang XiaoSong', 'wangxiaosong2.jpg', '副校长', '2003年毕业于西北工业大学工商管理专业，学士学位.曾先后在中国政府及私立学校任教。期间获得中国教师资格证书.普通话一级乙等.2012年至今担任樱花国际日语大连.青岛深圳等校区校长职务，负责校区的整体运营管理工作。拥有较强的组织和沟通能力，敢于面对挑战。'],
        ...
        ['陈晶珏', 'Chen JingJue', 'chenjingjue2.jpg', '教师', '陈晶珏老师，性格开朗，有耐心，喜欢和孩子打交道，热爱教师工作。爱好广泛，擅长教具制作工作。'],
