...
function get_teachers() {
    ...
    const teacher_arr = [
        ...
        ['何济生', 'He JiSheng', 'hejisheng_2.jpg', '教师', '毕业于新加坡国立大学（NUS），拥有语言学博士及硕士学位。精通中英文，具备丰富的语言教学知识与经验。持有新加坡国立教育学院（NIE）教育学研究生文凭，并接受过专业的中学华文教师培训。拥有16年新加坡教育部（MOE）学校教学经验，专业任教中学华文。具有丰富的学生备考与提分经验，尤其擅长帮助学生提升小学离校考试（PSLE）及O水准（O-Level）华文成绩。'],
