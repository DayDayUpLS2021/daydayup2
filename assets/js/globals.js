...
function get_teachers() {
    ...
    const teacher_arr = [
        ...
        ['王晓松', 'Wang XiaoSong', 'wangxiaosong2.jpg', '副校长', '毕业于西北工业大学工商管理专业，学士学位.曾先后在中国政府及私立学校任教。期间获得中国教师资格证书.普通话一级乙等.2012年至今担任樱花国际日语大连.青岛深圳等校区校长职务，负责校区的整体运营管理工作。拥有较强的组织和沟通能力，敢于面对挑战。'],
        ...
        ['蔡紫萱 ', 'Cai ZiXuan', 'caizixuan2.jpg', '教师', '拥有幼教经验，年轻有干劲儿，善于用真诚与热情与孩子拉近距离。注重营造尊重、鼓励与陪伴并存的课堂氛围。相信爱与耐心是教育最好的起点，也始终把“真诚、细致、责任心”作为一名老师应有的基本素养。'],
        ...
        ['黄绍杰', 'Huang ShaoJie', 'huangshaojie2.jpg', '教师', '毕业于华侨中学与华初。（等待当兵中）在求学过程中，积极参与学生会活动，并获得了许多宝贵的经验。愿意与大家分享经历，也愿意分享学习中文的乐趣。认为学习中文不只是为了应付考试，更重要的是了解中华文化。'],

        ['温凯杰', 'Wen KaiJie', 'wenkaijie2.jpg', '教师', '毕业于南华中学，小学起修读高级华文，中文成绩一向优秀。曾任课程辅助活动领袖，具责任感与领导力，教学耐心细致，注重理解与基础，助学生稳步进步。'],

        ['温凯畯', 'Wen KaiJun', 'wenkaijun2.jpg', '教师', '毕业于南华小学及华侨中学，华文及高级华文成绩优异。修读华文语文特选课程（华文文学）并获奖学金，曾在《联合早报》发表题为《青年对华文重视不足》的文章，亦曾参与义工补习，致力启发学生语文能力与兴趣。'],
